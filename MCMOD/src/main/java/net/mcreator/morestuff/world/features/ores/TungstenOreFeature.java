...
public class TungstenOreFeature extends OreFeature {
	public static final TungstenOreFeature FEATURE = (TungstenOreFeature) new TungstenOreFeature().setRegistryName("morestuff:tungsten_ore");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE
			.configured(new OreConfiguration(TungstenOreFeatureRuleTest.INSTANCE, MorestuffModBlocks.TUNGSTEN_ORE.defaultBlockState(), 16))
			.range(new RangeDecoratorConfiguration(UniformHeight.of(VerticalAnchor.absolute(0), VerticalAnchor.absolute(64)))).squared().count(20);
	...
	private static class TungstenOreFeatureRuleTest extends RuleTest {
		...
		static final RuleTestType<TungstenOreFeatureRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST,
				new ResourceLocation("morestuff:tungsten_ore_match"), () -> codec);
