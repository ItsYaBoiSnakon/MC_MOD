...
public class CobaltOreFeature extends OreFeature {
	public static final CobaltOreFeature FEATURE = (CobaltOreFeature) new CobaltOreFeature().setRegistryName("morestuff:cobalt_ore");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE
			.configured(new OreConfiguration(CobaltOreFeatureRuleTest.INSTANCE, MorestuffModBlocks.COBALT_ORE.defaultBlockState(), 7))
	...
	private static class CobaltOreFeatureRuleTest extends RuleTest {
		...
		static final RuleTestType<CobaltOreFeatureRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST,
				new ResourceLocation("morestuff:cobalt_ore_match"), () -> codec);
