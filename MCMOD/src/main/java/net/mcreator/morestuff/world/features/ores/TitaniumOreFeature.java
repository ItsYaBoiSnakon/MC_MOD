...
public class TitaniumOreFeature extends OreFeature {
	public static final TitaniumOreFeature FEATURE = (TitaniumOreFeature) new TitaniumOreFeature().setRegistryName("morestuff:titanium_ore");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE
			.configured(new OreConfiguration(TitaniumOreFeatureRuleTest.INSTANCE, MorestuffModBlocks.TITANIUM_ORE.defaultBlockState(), 7))
	...
	private static class TitaniumOreFeatureRuleTest extends RuleTest {
		...
		static final RuleTestType<TitaniumOreFeatureRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST,
				new ResourceLocation("morestuff:titanium_ore_match"), () -> codec);
